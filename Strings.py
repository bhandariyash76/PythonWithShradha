...
#you can also do the slicing with negative indices, which count from the end of the string. For example, -1 refers to the last character, -2 refers to the second-to-last character, and so on.
